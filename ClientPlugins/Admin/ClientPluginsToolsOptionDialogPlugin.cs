...
{
    public class ClientPluginsToolsOptionDialogPlugin : ToolsOptionsDialogPlugin
    {
        private ClientPluginsToolsOptionDialogUserControl _myUserControl;
        private Guid _myPropertyId = new Guid("D8979A59-D40D-4CEC-98FF-3BD06EE17B05");

        public override void Init()
        {
            // TODO: remove below check once ClientPluginsDefinition.ClientPluginsToolsOptionDialogPluginId has been replaced with proper GUID
            if (Id == new Guid("44444444-4444-4444-4444-444444444444"))
            {
                System.Windows.MessageBox.Show("Default GUID has not been replaced for ClientPluginsToolsOptionDialogPluginId!");
            }
        ...
        {
            get { return ClientPluginsDefinition.ClientPluginsToolsOptionDialogPluginId; }
        }


        public override ToolsOptionsDialogUserControl GenerateUserControl()
        {
            _myUserControl = new ClientPluginsToolsOptionDialogUserControl();
