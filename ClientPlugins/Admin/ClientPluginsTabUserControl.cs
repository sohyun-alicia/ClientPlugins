...
{
    public partial class ClientPluginsTabUserControl : VideoOS.Platform.Admin.TabUserControl
    {
        private Item _associatedItem;
        private bool _ignoreChanged = false;
        private AssociatedProperties _associatedProperties;

        public ClientPluginsTabUserControl(Item item)
        {
            InitializeComponent();
        ...
        public override void Init()
        {
            ...
            _associatedProperties = Configuration.Instance.GetAssociatedProperties(_associatedItem, ClientPluginsDefinition.ClientPluginsTabPluginId);
