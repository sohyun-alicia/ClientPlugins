...
namespace ClientPlugins.Admin
{
    ...
    /// </summary>
    public class ClientPluginsItemManager : ItemManager
    {
        private ClientPluginsUserControl _userControl;
        private Guid _kind;

        #region Constructors

        public ClientPluginsItemManager(Guid kind) : base()
        {
            _kind = kind;
        }
        ...
        {
            _userControl = new ClientPluginsUserControl();
        ...
        {
            return new ClientPluginsAddUserControl();
        }
        ...
        public override bool ValidateAndSaveUserControl()
        {
            if (CurrentItem != null)
            {
                ...
                Configuration.Instance.SaveItemConfiguration(ClientPluginsDefinition.ClientPluginsPluginId, CurrentItem);
            }
            return true;
        }
        ...
        {
            CurrentItem = new Item(suggestedFQID, ((ClientPluginsAddUserControl)addUserControl).ItemName);
            Configuration.Instance.SaveItemConfiguration(ClientPluginsDefinition.ClientPluginsPluginId, CurrentItem);
            return CurrentItem;
        }
        ...
        public override void DeleteItem(Item item)
        {
            if (item != null)
            {
                Configuration.Instance.DeleteItemConfiguration(ClientPluginsDefinition.ClientPluginsPluginId, item);
            }
        ...
        public override List<Item> GetItems()
        {
            ...
            List<Item> items = Configuration.Instance.GetItemConfigurations(ClientPluginsDefinition.ClientPluginsPluginId, null, _kind);
            return items;
        }
        ...
        {
            List<Item> items = Configuration.Instance.GetItemConfigurations(ClientPluginsDefinition.ClientPluginsPluginId, parentItem, _kind);
            return items;
        }
        ...
        {
            Item item = Configuration.Instance.GetItemConfiguration(ClientPluginsDefinition.ClientPluginsPluginId, _kind, fqid.ObjectId);
            return item;
        }
