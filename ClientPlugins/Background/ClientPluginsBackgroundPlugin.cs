...
namespace ClientPlugins.Background
{
    /// <summary>
    ...
    /// </summary>
    public class ClientPluginsBackgroundPlugin : BackgroundPlugin
    {
        ...
        {
            get { return ClientPluginsDefinition.ClientPluginsBackgroundPlugin; }
        }
        ...
        {
            get { return "ClientPlugins BackgroundPlugin"; }
        }
        ...
        public override void Init()
        {
            ...
            _thread.Name = "ClientPlugins Background Thread";
            _thread.Start();
        ...
        private void Run()
        {
            EnvironmentManager.Instance.Log(false, "ClientPlugins background thread", "Now starting...", null);
            while (!_stop)
            {
                // Do some work here.
            ...
            EnvironmentManager.Instance.Log(false, "ClientPlugins background thread", "Now stopping...", null);
            _thread = null;
        }
    }
}
