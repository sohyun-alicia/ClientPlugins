...
{
    public class ClientPluginsSettingsPanelPlugin : SettingsPanelPlugin
    {
        ...
        {
            get { return ClientPluginsDefinition.ClientPluginsSettingsPanel; }
        }

        /// <summary>
        /// Should return the title of this plug-in. It will be displayed in the Settings panel navigation list.
        /// </summary>
        public override string Title { get { return "ClientPlugins"; } }
        ...
        {
            _userControl = new ClientPluginsSettingsPanelControl(this);
            return _userControl;
        }
