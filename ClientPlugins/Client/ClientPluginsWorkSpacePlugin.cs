...
namespace ClientPlugins.Client
{
    public class ClientPluginsWorkSpacePlugin : WorkSpacePlugin
    {
        ...
        public override void Init()
        {
            ...
            rectangles.Add(new Rectangle(700, 000, 300, 1000));      // Index 1 = the sample ViewItem
            rectangles.Add(new Rectangle(000, 000, 700, 1000));     // Index 2
            ...
            properties2.Add("Scaling", "3"); // fit in 640x480
