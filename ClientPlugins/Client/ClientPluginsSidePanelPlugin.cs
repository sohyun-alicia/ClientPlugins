...
namespace ClientPlugins.Client
{
    ...
    /// </summary>
    public class ClientPluginsSidePanelPlugin : SidePanelPlugin
    {
        /// <summary>
        ...
        //{
        //	return new ClientPluginsSidePanelUserControl();
        //}
        ...
        {
            return new ClientPluginsSidePanelWpfUserControl();
        }
        ...
        {
            get { return ClientPluginsDefinition.ClientPluginsSidePanel; }
        }
        ...
        {
            get { return "ClientPlugins Side panel"; }
        }
