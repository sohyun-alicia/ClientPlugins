...
namespace ClientPlugins.Client
{
    ...
    /// </summary>
    public class ClientPluginsViewItemManager : ViewItemManager
    {
        private Guid _someid;
        private string _someName;
        private List<Item> _configItems;

        public ClientPluginsViewItemManager() : base("ClientPluginsViewItemManager")
        {
        }
        ...
        public override void PropertiesLoaded()
        {
            ...
            _configItems = Configuration.Instance.GetItemConfigurations(ClientPluginsDefinition.ClientPluginsPluginId, null, ClientPluginsDefinition.ClientPluginsKind);
        ...
        //{
        //	return new ClientPluginsViewItemUserControl(this);
        //}
        ...
        {
            return new ClientPluginsViewItemWpfUserControl(this);
        }
        ...
        //{
        //	return new ClientPluginsPropertiesUserControl(this);
        //}
        ...
        {
            return new ClientPluginsPropertiesWpfUserControl(this);
        }
