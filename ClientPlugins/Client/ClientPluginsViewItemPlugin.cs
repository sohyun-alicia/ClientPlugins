...
namespace ClientPlugins.Client
{
    ...
    /// </summary>
    public class ClientPluginsViewItemPlugin : ViewItemPlugin
    {

        public ClientPluginsViewItemPlugin()
        {
        }
        ...
        {
            get { return ClientPluginsDefinition.ClientPluginsViewItemPlugin; }
        }
        ...
        {
            return new ClientPluginsViewItemManager();
        }
